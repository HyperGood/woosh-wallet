...
const HelpScreen = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <HelpItem
        label={i18n.t('helpQ1')}
        answer={i18n.t('helpA1')}
        onPress={() => Linking.openURL('https://whatsapp.com/channel/0029VaPyZL21dAvu00J87z1q')}
      />
      <HelpItem
        label={i18n.t('helpQ2')}
        answer={i18n.t('helpA2')}
        onPress={() => Linking.openURL('https://wa.me/523111234567')}
      />
